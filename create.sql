...
create table user (id bigint not null auto_increment, date_of_birth date not null, description varchar(140), email varchar(255) not null, first_name varchar(255) not null, last_name varchar(255) not null, middle_name varchar(255), version bigint not null, primary key (id)) ENGINE=InnoDB
